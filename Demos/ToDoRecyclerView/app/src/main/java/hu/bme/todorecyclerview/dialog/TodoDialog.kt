...
class TodoDialog : DialogFragment() {
    ...
    interface TodoHandler {
        ...
        fun todoUpdate(editedTodo: Todo)
    }
    ...
    override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
        ...
        dialogBuilder.setPositiveButton("Create") {
            dialog, which ->
            // leave it empty
            // what's the bug? will not display error message here. need to overwrite in onResume method
        }
    ...
    fun handleTodoEdit() {
        ...
        todoHandler.todoUpdate(todoToEdit)
    }
