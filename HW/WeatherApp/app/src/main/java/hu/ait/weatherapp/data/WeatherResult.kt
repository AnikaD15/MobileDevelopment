...
data class WeatherResult(val coord: Coord?, val weather: List<Weather994373009>?,
...
data class Main(val temp: Number?, val feels_like: Number?,
                val temp_min: Number?, val temp_max: Number?,
                val pressure: Number?, val humidity: Number?)

data class Sys(val type: Number?, val id: Number?, val country: String?,
               val sunrise: Number?, val sunset: Number?)

data class Weather994373009(val id: Number?, val main: String?,
