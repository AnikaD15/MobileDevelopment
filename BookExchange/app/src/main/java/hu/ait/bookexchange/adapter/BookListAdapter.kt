...
//            parent, false)
        val binding = BookListCardBinding.inflate((context as BookListActivity).layoutInflater,
            parent, false)
    ...
    inner class ViewHolder(var binding: BookListCardBinding) : RecyclerView.ViewHolder(binding.root){
        fun bind(book: Book){
            binding.tvTitle.text = book.title
            binding.tvAuthor.text = book.author
            binding.tvPrice.text = (context as BookListActivity).getString(R.string.price, book.price)
